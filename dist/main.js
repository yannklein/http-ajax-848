...
var list = document.querySelector("#results"); // 2. Listen to a click on search btn

search.addEventListener("click", function (event) {
  console.log(event); // to prevent default page refresh after click

  event.preventDefault(); // 2.5 Fetch the OMDb API, get the input value (=keyword) and search for movies corresponding to the keyword
